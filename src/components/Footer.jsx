...
export default function Footer() {
  return (
    <footer className="bg-red-500 text-white py-16 px-6">
      <div className="mx-auto max-w-6xl grid gap-12 md:grid-cols-3">
        <div>
          <Link href="/" className="text-xl font-semibold text-white">DR</Link>
        </div>
      ...
      <div className="mt-12 border-t border-neutral-800 pt-8 text-center">
        <p className="mb-6 text-xs text-neutral-500">© {new Date().getFullYear()} Dalron J. Robertson. All rights reserved.</p>
