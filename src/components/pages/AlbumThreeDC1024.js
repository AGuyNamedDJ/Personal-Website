...
const AlbumThreeDC1024 = () => {
    const albumName = 'DC-Oct-24';
    const imageCount = 49;  // Replace with the actual number of images in the album
...
export default AlbumThreeDC1024;
