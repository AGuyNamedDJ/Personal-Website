...
const AlbumFourTSF = () => {
    const albumName = 'Texas-State-Fair';
    const imageCount = 96;  // Replace with the actual number of images in the album
    ...
    return (
        <div>
          <div id="titleSection-template">
            <h1>Texas State Fair '23-10.14'</h1>
          </div>
          <div className="album">
